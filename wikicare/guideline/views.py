...
def index(request):
    return render(request, 'wikicare/index.html') 
...
def index_patient(request):
    ...
    context = {
        ...
        'patients': patients}
    return render(request, 'wikicare/search_patient.html', context)

def patient(request, patient_id):
    patient = get_object_or_404(Patient, pk=patient_id)
    html = render_to_string('wikicare/patient.html', {'patient': patient})
...
def sys_guide(request):
    ...
    return render(request, 'wikicare/sys_guide.html', context)
...
def search_patient(request):
    ...
    patients = Patient.objects.all()
    return render(request, 'wikicare/choose_patient.html', {'patients': patients})
...
def new_patient(request):
    ...
    return render(request, 'wikicare/new_patient.html', {'form': form})

def new_patient_success(request):
    return render(request, 'wikicare/new_patient_success.html')
...
def symptom_rating_function(request, step=0):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if next_step < num_symptoms:
                ...
                return render(request, 'wikicare/preview_rating.html', context)
    ...
    return render(request, 'wikicare/symptom_rating.html', context)
...
def save_rating_success(request):
    ...
    if request.method == 'POST':
        ...
        if feedback_validation:      #if true, se for dar feedback a episódios anteriores
            ...
            return render(request, 'wikicare/feedback_success.html')
            ...
            return render(request, 'wikicare/choose_treatment.html', context)
...
def choose_sorting(request):
    if request.method == 'POST':
        ...
        return render(request, 'wikicare/choose_treatment.html', context)  # Render the sorted table view
...
def save_selected_treatments(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'wikicare/save_treatment_success.html', context)  # Redirect to a success page after saving the treatment
    else:
        return redirect('error')  # Redirect to an error page if the request method is not POST
...
def patient_history(request):
    ...
    return render(request, 'wikicare/patient_history.html', context)
...
def treatment_suitability(request):
    ...
    if request.method == 'POST':     
        ...
        if form.is_valid():
            ...
            return render(request, 'wikicare/suitability_success.html', context)  # Redirect to a success page or any other desired page
        else:
    ...
    return render(request, 'wikicare/suitability.html', context)
...
def error(request):
    return render(request, 'wikicare/error.html')
